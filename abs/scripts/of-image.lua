...
if args[1] == nil then print("[of.image] : No file");
else args[1] = filename;
M.setup();
end;
end;
;
...
function M.clear() M.image:clear() end;
...
if ofWindow.exists then ofDisableArbTex() M.image:clear();
loaded = M.image:load(filename) end;
